...
os.chdir('C:\in') #json file folder

event_list = requests.get('https://www.92y.org/calendar/index.aspx?monthDropDown=2016:5&kw=Event')
...
for i in list_links:
    ...
    for d in data_points:
        if d == 'event_link':
            ...
            event_dict[d] = date_list
        elif d == 'location':
            event_dict[d]  = location_list
        elif d == 'price':
            event_dict[d]  = price_list
        elif d == 'venue':
            event_dict[d] = venue_list
        else:
